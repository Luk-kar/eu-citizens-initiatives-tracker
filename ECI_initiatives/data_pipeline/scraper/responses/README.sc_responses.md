...
└── YYYY-MM-DD_HH-MM-SS/         # Existing timestamped folder
    ├── logs/
    │   └── scraper_responses_....log  # New log file
    ├── initiatives/             # (Read-only) Input files
    ├── responses/               # NEW: Downloaded response HTMLs
    │   ├── 2019/
    │   │   └── 2019_000007_en.html
    │   └── ...
    └── responses_list.csv       # NEW: Structured response data
```
