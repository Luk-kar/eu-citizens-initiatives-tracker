...
This module is the **final consolidation step** in the ECI pipeline. It takes the two parallel datasets generated by the extraction process—the official Commission response data and the granular follow-up website data—and intelligently merges them into a single, comprehensive accountability record.
...
The merger uses a column-by-column strategy to handle data conflicts. It doesn't just "overwrite"—it makes semantic decisions based on the field type:
